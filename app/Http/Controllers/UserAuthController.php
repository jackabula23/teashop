...
class UserAuthController extends Controller
{
    ...
    public function facebookSignInProcess()
    {
        ...
        return Socialite::driver('facebook')->scopes(['user_friends'])->redirectUrl($redirect_url)->redirect();
    ...
    public function facebookSignInCallbackProcess()
    {
        ...
        if (!is_null($User)) {
            // 沒有綁定 Facebook id 的帳號，透過Email尋找是否有此帳號
    ...
    public function githubSignInProcess()
    {
        ...
        return Socialite::driver('github')->redirectUrl($redirect_url)->redirect();
    }
