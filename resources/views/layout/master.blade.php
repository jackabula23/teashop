...
<head>
    ...
    <script src="{{asset('/assets/js/js.cookie.js')}}" defer></script>
    <script src="{{asset('/assets/js/shop-laravel.js')}}" defer></script>
    <link rel="stylesheet" href="{{asset('/assets/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('/assets/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('/assets/css/shop_laravel.css')}}">
</head>
<body>
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    <li><a href="{{url('/user/auth/sign-in')}}">{{ trans('shop.auth.sign-in') }}</a></li>
                    <li><a href="{{url('/user/auth/github-sign-in')}}">{{ trans('shop.auth.github-sign-in') }}</a></li>
                    <li><a href="{{url('/user/auth/facebook-sign-in')}}">{{ trans('shop.auth.facebook-sign-in') }}</a></li>
                    <li><a href="{{url('/user/auth/sign-up')}}">{{ trans('shop.auth.sign-up') }}</a></li>
                @endif
            </ul>
        </div>
    </div>
